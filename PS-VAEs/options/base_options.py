...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--loadSize', type=float, default=0.5, help='scale images to this size')
        ...
        self.parser.add_argument('--start_pose_epoch', type=int, default=0, help='start for pose loss')
        self.parser.add_argument('--divide_dims', type=int, default=64, help='divide feature between pose and others')

        self.parser.add_argument('--ngf', type=int, default=256, help='# of gen filters in first conv layer')
        self.parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in first conv layer')
        self.parser.add_argument('--netG_n_blocks', type=int, default=0, help='number of residual blocks to use for netG')
        ...
        self.parser.add_argument('--spectral_norm', action ='store_false', help='insert spectral normalization')
        self.parser.add_argument('--use_dropout', action='store_true', help='insert dropout for the generator')
        self.parser.add_argument('--est_joint', action='store_true', help='estimate joint position directly')
        self.parser.add_argument('--est_mnist', action='store_true', help='estimate mnist mode')

        self.parser.add_argument('--source', type=str, default='syn', help='source dataset')
        self.parser.add_argument('--target', type=str, default='rea', help='source dataset')
